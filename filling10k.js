...
async function getItemFor10k() {
    ...
    for (const link of data) {
        ...
        const filingData = {
            ...
            jsonContent: itemsContent.reduce((acc, item) => {
                acc[`item_${item.itemname}`] = item.content; // Add item content dynamically
                return acc;
            }, {})
        };
    ...
    fs.writeFileSync("itemfilling10k_final.json", JSON.stringify(finalContent, null, 2));
